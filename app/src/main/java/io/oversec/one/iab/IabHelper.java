...
public class IabHelper {
     ...
     * Activity's {@link android.app.Activity@handleActivityResult} method. This method
     * MUST be called from the UI thread of the Activity.
     *
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            throw new IabException(IABHELPER_UNKNOWN_ERROR, "something went completely wrong! (NullPointerException)");
        }
    }
